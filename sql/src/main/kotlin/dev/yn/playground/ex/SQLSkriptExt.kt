...
fun <C: SQLSkriptContext<*>> Skript<Unit, Unit, C>.dropTableIfExists(tableName: String) =
...
fun <C: SQLSkriptContext<*>> Skript<Unit, Unit, C>.deleteAll(tableName: String) =
...
fun <I, O, J, C: SQLSkriptContext<*>> Skript<I, O, C>.query(mapping: SQLQueryMapping<O, J>) =
        this.andThen(SQLSkript.query(mapping))

fun <I, O, J, C: SQLSkriptContext<*>> Skript<I, O, C>.update(mapping: SQLUpdateMapping<O, J>) =
        this.andThen(SQLSkript.update(mapping))

fun <I, O, J, C: SQLSkriptContext<*>> Skript<I, O, C>.exec(mapping: SQLExecMapping<O, J>) =
