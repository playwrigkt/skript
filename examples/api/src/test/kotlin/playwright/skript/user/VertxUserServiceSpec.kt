...
class VertxUserServiceSpec: UserServiceSpec() {
    companion object {
        ...
        val consumerPerformerProvider = VertxConsumerStage(vertx)
    }

    override fun provider(): ApplicationVenue = VertxUserServiceSpec.provider
    override fun consumerPerformerProvider(): playwright.skript.consumer.alpha.ConsumerStage = consumerPerformerProvider
