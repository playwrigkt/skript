...
class VertxUserServiceSpec: UserServiceSpec() {
    companion object {
        ...
        val serializeVenue by lazy { VertxSerializeVenue() as Venue<SerializePerformer> }

        val provider: ApplicationVenue by lazy {
            ApplicationVenue(publishVenue, sqlConnectionProvider, serializeVenue)
        }
        val CONSUMER_STAGE: playwright.skript.consumer.alpha.ConsumerStage = VertxConsumerStage(vertx)
    }
